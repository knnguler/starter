...
>
    ...
    <div
        ...
        class="fixed inset-y-0 {{ $side === 'left' ? 'left-0' : 'right-0' }} z-50 w-[250px] bg-sidebar border-r border-sidebar-border"
    >
        {{-- Close button --}}
        <button
            @click="openMobile = false"
...
>
    ...
    <div
        ...
        transition-[left,right,width] duration-200 ease-linear md:flex py-1
